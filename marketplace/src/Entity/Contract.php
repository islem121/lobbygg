...
class Contract
{
    ...
    #[ORM\Column(type: Types::TEXT, nullable: true)]
    private ?string $sponsorSignature = null;
    ...
    public function getSponsorSignature(): ?string
    {
        return $this->sponsorSignature;
    }

    public function setSponsorSignature(?string $sponsorSignature): static
    {
