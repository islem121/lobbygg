...
class ProductController extends AbstractController
{
    ...
    public function index(Request $request, ProductRepository $productRepository, PaginatorService $paginatorService): Response
    {
        $page = $request->query->getInt('page', 1);
        $pagination = $paginatorService->paginate($productRepository->findAllQuery(), $page, 10);
