...
#[ORM\Entity(repositoryClass: WaitingListEntryRepository::class)]
#[ORM\Table(name: 'waiting_list_entry')]
#[ORM\UniqueConstraint(name: 'uniq_waiting_tournament_user', columns: ['tournament_id', 'user_id'])]
